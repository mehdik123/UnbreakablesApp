-- =====================================================
-- COMPLETE INGREDIENTS FIX SCRIPT
-- 1. Remove duplicates
-- 2. Update with correct nutritional values from CSV
-- 3. Add missing ingredients
-- =====================================================

-- Step 1: Remove all existing ingredients to start fresh
DELETE FROM meal_items;
DELETE FROM ingredients;

-- Step 2: Insert all ingredients with correct nutritional values from your CSV
...
-- Step 3: Verify the ingredients were inserted correctly
SELECT 
    name,
    kcal,
    protein,
