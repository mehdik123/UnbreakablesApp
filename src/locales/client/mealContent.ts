...
const INGREDIENTS: Record<string, Pair> = {
  ...
  'mixed nuts & banana': { ar: 'مكسرات و بنان', fr: 'Noix et banane' },
  'dates and nuts': { ar: 'تمر و مكسرات', fr: 'Dattes et noix' },
  ...
  'body attack extreme whey deluxe, chocolate coconut': { ar: 'واي بودي أتاك شوكو-جوز الهند', fr: 'Whey Deluxe chocolat-coco' },
...
const MEAL_NAMES: Record<string, Pair> = {
  ...
  'egg omlet with bread & avocado': { ar: 'أومليت مع خبز و أفوكا', fr: 'Omelette, pain et avocat' },
  ...
  'greek yogurt with banana and berries': { ar: 'ياغورت يوناني مع بنان و فواكه حمرا', fr: 'Yaourt grec, banane et fruits rouges' },
  ...
  'rice with chicken breast and green beans': { ar: 'روز مع صدر دجاج و لوبيا خضرا', fr: 'Riz au poulet et haricots verts' },
  ...
  'scrambled eggs with oatmeal and honey': { ar: 'بيض مخفوق مع شوفان و عسل', fr: 'Œufs brouillés, avoine et miel' },
  ...
  'sweet potatoes and chicken breast': { ar: 'بطاطا حلوة و صدر دجاج', fr: 'Patates douces et blanc de poulet' },
...
export const COOKING_BY_MEAL: Record<string, Cooking> = {
  ...
  'dates and nuts': {
    en: 'Pit the dates if needed. Serve dates with mixed nuts as a simple snack — no cooking required.',
    ar: 'نقّي التمر إلا كان في نواة. قدّم التمر مع المكسرات كسناك بسيط — ما كاينش طبخ.',
    fr: 'Dénoyaute les dattes si besoin. Sers-les avec un mélange de noix — aucune cuisson nécessaire.',
  },
  ...
  'chicken breast with pasta & cheese': {
    en: 'Boil Pasta in Water, Add 1 tbsp of olive oil to a frying pan and cook the chicken breast under medium heat along with the mushrooms, when cooked , mix everything ( mushrooms, cheese , garlic slices )',
    ar: 'سلق الباتا في الماء. حط معلقة زيت الزيتون في المقلاة و طيب صدر الدجاج مع الفطر على نار متوسطة. ملي يطيب، خلط الفطر، الفرماج و شرائح التومة.',
    fr: 'Fais bouillir les pâtes. Dans une poêle avec 1 c. à soupe d’huile d’olive, cuis le poulet et les champignons à feu moyen. Mélange ensuite avec les champignons, le fromage et l’ail.',
  },
  'egg omlet with bread and avocado': {
    en: 'Whisk eggs and scramble them in a non-stick skillet over medium heat until they are fully cooked but still moist. While the eggs are cooking, toast the whole bread slices. Top the toast with mashed avocado, eggs and cheddar cheese.',
    ar: 'خفق البيض و طيبو في مقلاة على نار متوسطة حتى يطيبو و يبقاو رطبين. في نفس الوقت حمص شرائح الخبز الكامل. حط الأفوكا مهرسة، البيض و الشيدر فوق التوست.',
    fr: 'Bats les œufs et brouille-les à feu moyen, cuits mais moelleux. Toaste le pain complet. Garnis avec avocat écrasé, œufs et cheddar.',
  },
  'egg omlet with bread & avocado': {
    en: 'Whisk eggs and scramble them in a non-stick skillet over medium heat until they are fully cooked but still moist. While the eggs are cooking, toast the whole bread slices. Top the toast with mashed avocado, eggs and cheddar cheese.',
    ar: 'خفق البيض و طيبو في مقلاة على نار متوسطة حتى يطيبو و يبقاو رطبين. في نفس الوقت حمص شرائح الخبز الكامل. حط الأفوكا مهرسة، البيض و الشيدر فوق التوست.',
    fr: 'Bats les œufs et brouille-les à feu moyen, cuits mais moelleux. Toaste le pain complet. Garnis avec avocat écrasé, œufs et cheddar.',
  },
  ...
  'greek yogurt with banana and berries': {
    en: 'Spoon the Greek yogurt into a bowl. Top with sliced banana and mixed berries. Serve cold.',
    ar: 'حط الياغورت اليوناني في زلافة. زيد بنان مقطع و فواكه حمرا. قدّمو بارد.',
    fr: 'Verse le yaourt grec dans un bol. Ajoute la banane tranchée et les fruits rouges. Sers froid.',
  },
  ...
  'ground beef with rice ,onion and broccoli': {
    en: 'Cook the rice and broccoli in boiled water and add your favourite seasoning. Add olive oil to a frying pan to avoid sticking and cook the beef and onion, when cooked, add the cheese and mix everything.',
    ar: 'طيب الروز و البروكلي في الماء مع التوابل. قلي الكفتة و البصل في زيت الزيتون، زيد الفرماج و خلط كلشي.',
    fr: 'Cuis le riz et le brocoli avec tes épices. Fais revenir le bœuf et l’oignon, ajoute le fromage et mélange le tout.',
  },
  ...
  'mixed nuts & banana': {
    en: 'Peel and slice the banana. Serve with mixed nuts in a bowl or on the side. No cooking required.',
    ar: 'قشر البنان و قطّعو. قدّمو مع المكسرات في زلافة أو على الجنب. ما كاينش طبخ.',
    fr: 'Épluche et tranche la banane. Sers avec un mélange de noix — aucune cuisson nécessaire.',
  },
  ...
  'rice with chicken breast and green beans': {
    en: 'Cook the rice and green beans in boiled water and add your favourite seasoning. Add olive oil to a frying pan to avoid sticking and cook the chicken breast and onion, when cooked, add the cheese and mix everything in a bowl.',
    ar: 'طيب الروز و اللوبيا الخضرا في الماء مع التوابل. قلي صدر الدجاج و البصل في زيت الزيتون، زيد الفرماج و خلط في زلافة.',
    fr: 'Cuis le riz et les haricots verts avec tes épices. Fais revenir le poulet et l’oignon, ajoute le fromage et mélange dans un bol.',
  },
  ...
  'scrambled eggs with oatmeal': {
    en: 'Start by cooking the oatmeal in milk until creamy and soft. While the oatmeal is cooking, beat the eggs and then scramble them in a skillet with a tablespoon of olive oil, ensuring they remain fluffy and light. Once both the oatmeal and eggs are ready, stir a tablespoon of honey into the oatmeal for extra richness. Serve the scrambled eggs alongside the oatmeal and sprinkle the banana slices over the oatmeal for a burst of freshness and sweetness.',
    ar: 'طيب الشوفان في الحليب حتى يولي كريمي. في نفس الوقت طيب البيض المخفوق في زيت الزيتون. حرّك معلقة عسل في الشوفان. قدّم البيض مع الشوفان و رش شرائح البنان من الفوق.',
    fr: 'Cuis l’avoine dans le lait jusqu’à ce qu’elle soit crémeuse. Brouille les œufs à part dans un peu d’huile d’olive. Ajoute une cuillère de miel dans l’avoine. Sers avec les œufs et des tranches de banane.',
  },
  ...
  'sweet potatoes and chicken breast': {
    en: 'Boil the sweet potatoes, add a small tablespoon of olive oil to a frying pan and cook the chicken breast along with the spinach, when cooked, mix everything in a bowl, add avocado slices and your favourite seasoning.',
    ar: 'سلق البطاطا الحلوة. حط شوية زيت الزيتون في المقلاة و طيب صدر الدجاج مع السبانخ. ملي يطيب، خلط كلشي في زلافة، زيد شرائح الأفوكا و التوابل لي بغيتي.',
    fr: 'Fais bouillir les patates douces. Dans une poêle avec un peu d’huile d’olive, cuis le poulet avec les épinards. Mélange le tout dans un bol, ajoute l’avocat et tes épices.',
  },
  ...
  'tuna and rice salad': {
    ...
    ar: 'طيب الروز حتى يطرى. زيد علبة ثون، شرائح الأفوكا، المايس و الشيدر. تقدر زيد التوابل لي بغيتي.',
    fr: 'Cuis le riz. Ajoute le thon, l’avocat, le maïs et le cheddar. Ajoute tes épices si tu veux.',
  },
