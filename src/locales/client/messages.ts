...
export const clientMessages: Record<ClientLocale, Record<string, string>> = {
  en: {
    ...
    'home.openWorkouts': 'Open workouts',
    'home.currentWeekHint': 'Your latest training week from Mehdi. Pick any day inside when you train.',
  ...
  ar: {
    ...
    'home.openWorkouts': 'فتح التمارين',
    'home.currentWeekHint': 'أحدث أسبوع تدريب من مهدي. اختر أي يوم داخل الأسبوع عند التمرين.',
  ...
  fr: {
    ...
    'home.openWorkouts': 'Ouvrir les séances',
    'home.currentWeekHint': 'Votre dernière semaine d’entraînement de Mehdi. Choisissez n’importe quel jour quand vous vous entraînez.',
