-- =====================================================
-- COMPLETE MEALS POPULATION SCRIPT
-- Using the exact same approach as coach interface
-- Simple INSERT statements - no ON CONFLICT needed
-- =====================================================

-- Step 1: Add all missing ingredients from your CSV with proper nutritional values
INSERT INTO ingredients (name, kcal, protein, fat, carbs)
VALUES 
    ('Cheddar Cheese', 403, 25, 33, 1.3),
    ('Whole Milk', 61, 3.2, 3.3, 4.8),
    ('Turkey Bacon', 382, 30, 28, 0),
    ('Optimum Gold Standard Whey Protein Powder', 400, 80, 5, 10),
    ('Perly', 59, 10, 0.4, 3.6),
    ('Lean Ground Beef', 250, 26, 15, 0),
    ('Rice', 130, 2.7, 0.3, 28),
    ('Green Beans', 31, 1.8, 0.2, 7),
    ...
    ('Cottage Cheese, 1% milkfat', 72, 12, 1, 4.3),
    ('Kiwi', 61, 1.1, 0.5, 15),
