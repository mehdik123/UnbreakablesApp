-- Complete meal population script with proper conflict handling
-- This script adds meals and links them to your EXISTING ingredients.

-- Step 1: Add missing ingredients first
...
-- Step 3: Add meal items for each meal (using correct ingredient names)
